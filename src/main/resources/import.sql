...
INSERT INTO item (DATA_EHORA_ENCONTRADO_OU_PERDIDO, ESTADO_DE_DEVOLUCAO, EXPRIRACAO_NO_FEED, CATEGORIA_ID, ESTADO_ID, LOCALIZACAO_ID, USUARIO_ID, DESCRICAO, FOTO, NOME) VALUES ('2024-04-27', 1, '2024-05-27', 1, 1, 1, 1, 'Item 1: Descrição', '/caminho/para/foto1.jpg', 'Item 1');
INSERT INTO item (DATA_EHORA_ENCONTRADO_OU_PERDIDO, ESTADO_DE_DEVOLUCAO, EXPRIRACAO_NO_FEED, CATEGORIA_ID, ESTADO_ID, LOCALIZACAO_ID, USUARIO_ID, DESCRICAO, FOTO, NOME) VALUES ('2024-04-28', 0, '2024-05-28', 2, 2, 2, 2, 'Item 2: Descrição', '/caminho/para/foto2.jpg', 'Item 2');
INSERT INTO item (DATA_EHORA_ENCONTRADO_OU_PERDIDO, ESTADO_DE_DEVOLUCAO, EXPRIRACAO_NO_FEED, CATEGORIA_ID, ESTADO_ID, LOCALIZACAO_ID, USUARIO_ID, DESCRICAO, FOTO, NOME) VALUES ('2024-05-01', 0, '2024-06-01', 2, 2, 1, 3, 'Item 30: Descrição', '/caminho/para/foto30.jpg', 'Item 30');
INSERT INTO item (DATA_EHORA_ENCONTRADO_OU_PERDIDO, ESTADO_DE_DEVOLUCAO, EXPRIRACAO_NO_FEED, CATEGORIA_ID, ESTADO_ID, LOCALIZACAO_ID, USUARIO_ID, DESCRICAO, FOTO, NOME) VALUES ('2024-05-02', 0, '2024-05-30', 1, 1, 2, 1, 'Item 4: Descrição', '/caminho/para/foto4.jpg', 'Item 4');
